...
Route::controller(AdminMovieController::class)->prefix('admin')->middleware('admin')->group(function () {
...
Route::controller(AdminQuoteController::class)->prefix('admin')->middleware('admin')->group(function () {
